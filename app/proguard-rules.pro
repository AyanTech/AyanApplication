...
#-keep class ir.ayantech.ayannetworking.ayanModel.** { *; }
#-keep public class ir.ayantech.pushnotification.** { *; }
#-keep public class ir.ayantech.pushsdk.model.** { *; }
#-keep public class ir.ayantech.pushsdk.** { *; }
#-keep public class ir.ayantech.versioncontrol.** { *; }
#-keep public class ir.ayantech.versioncontrol.model.** { *; }

-keepclassmembers class ir.ayantech.ayannetworking.ayanModel.** {
    *;
}

-keep class ir.ayantech.pushsdk.** {
    *;
}

-keep class ir.ayantech.ocr_sdk.** {
    *;
}

-keep class ir.ayantech.versioncontrol.** {
    *;
}

-keepclassmembers class ir.ayantech.ghabzino.model.** {
    *;
}

-keepclassmembers class ir.ayantech.ghabzino.shaparak.model.** {
    *;
}

-keepclassmembers class ir.ayantech.ghabzino.shaparak.api.** {
    *;
}
...
#-------------------------------Needed-----------------------------
-keep class ir.ayantech.whygoogle.helper.FragmentArgumentDelegate.** { *; }
-keep class ir.ayantech.whygoogle.helper.FragmentArgumentDelegateKt.** { *; }
-keep class ir.ayantech.whygoogle.helper.FragmentNullableArgumentDelegate.** { *; }
-keep class ir.ayantech.whygoogle.helper.FragmentViewBindingDelegate.** { *; }
-keepnames class ir.ayantech.whygoogle.fragment.WhyGoogleFragment { *; }
-keepnames class ir.ayantech.whygoogle.activity.WhyGoogleActivity { *; }
-keepnames class * extends ir.ayantech.whygoogle.fragment.WhyGoogleFragment { *; }
-keepnames class * extends ir.ayantech.whygoogle.activity.WhyGoogleActivity { *; }
...
-keepnames class ir.ayantech.ghabzino.ui.base.BaseBottomSheet { *; }
-keepnames class * extends ir.ayantech.ghabzino.ui.base.BaseBottomSheet { *; }
